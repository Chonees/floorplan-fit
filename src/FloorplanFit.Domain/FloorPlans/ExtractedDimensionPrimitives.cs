...
public sealed record ExtractedDimensionLinePrimitive(
    string PrimitiveKey,
    int SortOrder,
    decimal StartX,
    decimal StartY,
...
public sealed record ExtractedDimensionTextPrimitive(
    string PrimitiveKey,
    int SortOrder,
    string Text,
    decimal X,
...
public sealed record ExtractedDimensionInsertPrimitive(
    string PrimitiveKey,
    int SortOrder,
    string Name,
    decimal X,
...
public sealed record ExtractedDimensionCirclePrimitive(
    string PrimitiveKey,
    int SortOrder,
    decimal CenterX,
    decimal CenterY,
...
public sealed record ExtractedDimensionArcPrimitive(
    string PrimitiveKey,
    int SortOrder,
    decimal CenterX,
    decimal CenterY,
...
public sealed record ExtractedDimensionSolidPrimitive(
    string PrimitiveKey,
    int SortOrder,
    decimal Point1X,
    decimal Point1Y,
